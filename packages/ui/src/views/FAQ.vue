<template>
  <div id="faq">
    ...
    <br />
    <p><strong>3. I lost my streak! Can you get it back for me?</strong></p>
    <p>
      Unfortunately as your save data isn't stored on any servers for privacy
      reasons, we can't set your streak back.
    </p>
    <br />
