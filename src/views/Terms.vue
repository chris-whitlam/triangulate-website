<template>
  <div id="terms">
    ...
    <p>
      By downloading or using the app (Triangulate), these terms will
      automatically apply to you – therefore, you should make sure that you read
      ...
      to Christopher Whitlam (ChrisWhitlamDev).
    </p>
    <p>
      Christopher Whitlam (ChrisWhitlamDev) is committed to ensuring that the
      app is as useful and efficient as possible. For that reason, we reserve
      the right to make changes to the app or to charge for its services, at any
    ...
    <p>
      The Triangulate app stores and processes personal data that you have
      ...
      features and it could mean that the Triangulate app won’t work properly or
      at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Christopher Whitlam
      (ChrisWhitlamDev) will not take responsibility for. Certain functions of
      ...
      Christopher Whitlam (ChrisWhitlamDev) cannot take responsibility for the
    ...
    <p>
      Along the same lines, Christopher Whitlam (ChrisWhitlamDev) cannot always
      take responsibility for the way you use the app i.e. You need to make sure
      that your device stays charged – if it runs out of battery and you can’t
      turn it on to avail the Service, Christopher Whitlam (ChrisWhitlamDev)
      cannot accept responsibility.
    </p>
    <p>
      With respect to Christopher Whitlam (ChrisWhitlamDev)’s responsibility for
      your use of the app, when you’re using the app, it’s important to bear in
      mind that although we endeavor to ensure that it is updated and correct at
      all times, we do rely on third parties to provide information to us so
      that we can make it available to you. Christopher Whitlam
      (ChrisWhitlamDev) accepts no liability for any loss, direct or indirect,
      you experience as a result of relying wholly on this functionality of the
      app.
    </p>
    <p>
      ...
      the app. Christopher Whitlam (ChrisWhitlamDev) does not promise that it
      will always update the app so that it is relevant to you and/or works with
