<template>
  <div id="privacy-policy">
    ...
    <p>
      Christopher Whitlam (ChrisWhitlamDev) built the Triangulate app as a Free
      app. This SERVICE is provided by Christopher Whitlam (ChrisWhitlamDev) at
    ...
    <p>
      ...
      other statistics. The Log Data is also used to provide insight into your
      usage of the Service in order to help improve the experience of the
      Service in future versions.
    </p>
    <p>
      You can opt-out of analytics collection at any point within the Service.
    </p>
    <h3>Cookies</h3>
    <p>
    ...
    <div>
      <p>
        ...
        personal information from any servers used by the Service. If you are a
